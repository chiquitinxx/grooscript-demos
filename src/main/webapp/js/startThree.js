...
gs.mc(gs.execStatic(Three,'scene', this,[function(it) {
  gs.mc(gs.gp(gs.mc(this,"tetrahedron",[200]),"position"),"set",[-360, 300, 300]);
  gs.mc(gs.gp(gs.mc(this,"icosahedron",[200]),"position"),"set",[360, 200, 300]);
  gs.mc(gs.gp(gs.mc(this,"sphere",[100, 50, 50]),"position"),"set",[-300, -200, 100]);
  gs.mc(gs.gp(gs.mc(this,"torus",[200, 50, 50, 50]),"position"),"set",[-300, -200, 100]);
  gs.mc(gs.gp(gs.mc(this,"ring",[20, 200, 50]),"position"),"set",[450, -200, 100]);
